...
import Ex4, robot_models
#Har importeret vores grid i stedet for deres 

def main():

    path_res = 0.05
    map = Ex4.GridOccupancyMap(low=(-1, 0), high=(1, 2), res=path_res) # Har brugt vores grid i stedet for deres 
    map.populate()
